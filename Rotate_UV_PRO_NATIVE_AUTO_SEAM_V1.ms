...
(
    ...
    (
        ...
        label lbl_unfoldScope "Seams first -> Unfold" pos:[176,336] width:112 height:16 align:#center tooltip:"Recommended workflow: Analyze -> Preview -> Apply -> Unfold. Straighten remains independent."
...
") + getCurrentException()) title:"Rotate UV - Unfold"
        ...
        on btn_unfold pressed do runUnfold3D optimizeOnly:false
