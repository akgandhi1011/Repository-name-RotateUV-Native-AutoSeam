...
(
    ...
    (
        ...
        button btn_unfold "" pos:[18,329] width:34 height:31 iconName:@"EditUVW\QuickPeel" iconSize:[23,23] tooltip:"Native Unfold - seam-constrained LSCM flattening for tubes, boxes, chamfered boxes and general cut shells. Requires applied Peel/Pelt seams. Falls back to 3ds Max Unfold3D if the native worker is unavailable."
...
") + getCurrentException()) title:"Rotate UV - Unfold"
        ...
        ----------------------------------------------------------------------
        -- NATIVE UNFOLD V1 - seam-constrained LSCM solver
        --
                    ...
                    (
                        ...
                        (
                            ...
                            (
                                ...
                                setStatus ("Native Unfold: " + imported[3] as string + " charts | LSCM" + flipText)
                            )
                            else
                            (
